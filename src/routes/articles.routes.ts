...
import { uploadArticleImage, uploadArticleContentImage } from "../middlewares/upload.middleware";
...
articlesRoutes.post("/content-image", requireAuth, requireRole("ADMIN"), uploadArticleContentImage, multerErrorHandler, articlesController.uploadArticleContentImage);
